...
public class PostController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<PostEntity> listar(@PathVariable("id") long id) {
	...
	@PostMapping("/post")
	  public ResponseEntity<PostEntity> create(@RequestBody PostEntity p) {
	    try {
	...
	@PutMapping("/post/{id}")
	  public ResponseEntity<PostEntity> update(@PathVariable("id") long id, @RequestBody PostEntity p) {
	    PostEntity post = postService.read(id);
